...
train_filedata<-file.path("./train/X_train.txt")
#Get activity ids
test_filedataids<-file.path("./test/y_test.txt")
train_filedataids<-file.path("./train/y_train.txt")
# Get subject ids
test_filesubids<-file.path("./test/subject_test.txt")
train_filesubids<-file.path("./train/subject_train.txt")

# Read the rownames from features.txt
colnamesall<-read.table("features.txt")
...
#write output files: txt and csv "ONLY txt needed for project"
